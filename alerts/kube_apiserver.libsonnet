      ...
      },
      {
        ...
        rules: [
          ...
          },
          {
            ...
            expr: |||
              sum by(%(clusterLabel)s, name, namespace)(increase(aggregator_unavailable_apiservice_count[5m])) > 2
            ||| % $._config,
            labels: {
              severity: 'warning',
            },
          ...
          },
          {
            ...
            expr: |||
              (1 - max by(%(clusterLabel)s, name, namespace)(avg_over_time(aggregator_unavailable_apiservice[10m]))) * 100 < 85
            ||| % $._config,
            'for': '5m',
            labels: {
              severity: 'warning',
